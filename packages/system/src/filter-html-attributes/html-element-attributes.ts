import type { HtmlElementAttributesMap } from "./html-element-attributes.types";

const htmlElementAttributes: HtmlElementAttributesMap = {
  "*": [
    "accesskey",
    "autocapitalize",
    "autofocus",
  ...
  optgroup: ["muted", "label"],
  option: ["muted", "label", "selected", "value"],
  ...
  select: ["autocomplete", "muted", "form", "multiple", "name", "required", "size"],
  slot: ["name"],
  ...
  template: ["shadowrootclonable", "shadowrootdelegatesfocus", "shadowrootmode"],
  textarea: [
    "autocomplete",
    "cols",
    "dirname",
